<template>
	<view :class="['uni-collapse-cell', { 'uni-collapse-cell--disabled': disabled, 'uni-collapse-cell--open': isOpen }]" :hover-class="disabled ? '' : 'uni-collapse-cell--hover'">
		<view class="uni-collapse-cell__title" @click="onClick" :style="!padding ? 'padding:0;padding-right:10upx;' : ''">
			<view class="uni-collapse-cell__title-extra" v-if="thumb"><image class="uni-collapse-cell__title-img" :src="thumb"></image></view>
			...
			<view class="uni-collapse-cell__title-arrow" :class="{ 'uni-active': isOpen, 'uni-collapse-cell--animation': showAnimation === true }">
				<view class="cuIcon-right padding-right-xl"></view>
			</view>
		</view>
